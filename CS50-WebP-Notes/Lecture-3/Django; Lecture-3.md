...
6. 1. Now, we have to install our new app. To do this, we go to `settings.py`, scroll down to the list of `INSTALLED_APPS`, and add the name of our new application to this list. 
	![[Pasted image 20230909113932.png]]
...
![[Pasted image 20231001220410.png]]
